...
class SupertsetPluginCustomApplicationStatus extends _core.ChartPlugin {
  /**
  ...
  constructor() {
    var metadata = new _core.ChartMetadata({
      description: 'Supertset Plugin Custom Application Status',
      name: (0, _core.t)('Supertset Plugin Custom Application Status'),
      thumbnail: _thumbnail.default
    });
    super({
      buildQuery: _buildQuery.default,
      controlPanel: _controlPanel.default,
      loadChart: () => Promise.resolve().then(() => _interopRequireWildcard(require('../SupertsetPluginCustomApplicationStatus'))),
      metadata,
