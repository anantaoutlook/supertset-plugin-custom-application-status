...
const row_limit = {
  ...
  description: (0, _core.t)('Limits the number of rows that get displayed.')
};
const limit = {
  type: 'SelectControl',
  freeForm: true,
  ...
  clearable: true,
  description: (0, _core.t)('Limits the number of series that get displayed. A joined subquery (or an extra phase ' + 'where subqueries are not supported) is applied to limit the number of series that get ' + 'fetched and rendered. This feature is useful when grouping by high cardinality ' + 'column(s) though does increase the query complexity and cost.')
};
const series_limit = {
  type: 'SelectControl',
  freeForm: true,
...
const sort_by = {
  ...
  default: null,
  description: (0, _core.t)('Metric used to define how the top series are sorted if a series or row limit is present. ' + 'If undefined reverts to the first metric (where appropriate).'),
  mapStateToProps: ({
    datasource
  }) => ({
