 ...
 * under the License.
 */
import { SupertsetPluginCustomApplicationStatus } from '../src';
 ...
 */
describe('supertset-plugin-custom-application-status', () => {
  it('exists', () => {
    expect(SupertsetPluginCustomApplicationStatus).toBeDefined();
  });
});
